...
conquest: 
  ...
  plantsDesert: createGroundCoverLayer({
    ...
    materials: [
      ...
      { identifier: "conquest:warped_fungus", count: 10, scale: 0.1 },
  ...
  leavesPlains: createGroundCoverLayer({
    name: "leaves_plains",
    materials: [
      //{ identifier: "conquest:half_dead_cypress_leaves", count: 100 },
      //{ identifier: "conquest:aspen_leaves", count: 100 },
      { identifier: "conquest:beech_tree_leaves", count: 100 },
      { identifier: "conquest:purple_cherry_blossoms", count: 100 },
    ],
    thickness: 2,
    persistent: true,
  }),
  leavesDesert: createGroundCoverLayer({
    name: "leaves_desert",
    materials: [
      { identifier: "conquest:olive_tree_leaves", count: 100 },
      { identifier: "conquest:goat_willow_leaves", count: 100 },
      { identifier: "conquest:dead_cypress_leaves", count: 100 },
      { identifier: "conquest:date_palm_leaves", count: 100 },
    ],
    thickness: 2,
    persistent: true,
  }),
  leavesTaiga: createGroundCoverLayer({
    ...
    materials: [
      { identifier: "conquest:rowan_leaves", count: 100 },
      //{ identifier: "conquest:autumnal_oak_leaves", count: 100 },
      //{ identifier: "conquest:autumnal_maple_leaves", count: 100 },
      { identifier: "conquest:autumnal_aspen_leaves", count: 100 },
      { identifier: "conquest:banana_tree_leaves", count: 100 },
    ],
    thickness: 2,
    persistent: true,
  }),
  leavesGrove: createGroundCoverLayer({
    name: "leaves_grove",
    materials: [
      { identifier: "conquest:downy_willow_leaves", count: 100 },
      //{ identifier: "conquest:light_spruce_needles", count: 100 },
      { identifier: "conquest:larch_needles", count: 100 },
      //{ identifier: "conquest:apple_tree_leaves", count: 100 },
    ],
    thickness: 2,
    persistent: true,
  }),
  leavesFrozenPlains: createGroundCoverLayer({
    name: "leaves_frozen_plains",
    materials: [
      { identifier: "conquest:dead_cypress_leaves", count: 100 },
      { identifier: "conquest:half_dead_cypress_leaves", count: 100 },
      { identifier: "conquest:dead_pine_needles", count: 100 },
      //{ identifier: "conquest:dead_deciduous_branches", count: 100 },
    ],
    thickness: 2,
    persistent: true,
  }),
