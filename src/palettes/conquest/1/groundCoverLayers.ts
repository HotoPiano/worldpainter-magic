...
conquest: 
  ...
  */
  ...
  plantsDesert: createGroundCoverLayer({
    name: "plants_desert",
    materials: [
      { identifier: "conquest:dead_grass", count: 200, scale: 0.4 },
      ...
      { identifier: "conquest:small_fescue", count: 50, scale: 0.4 },
      ...
      { identifier: "conquest:yellow_wolfs_bane", count: 5, scale: 0.4 },
    ],
    thickness: 2,
    scale: 1.5,
  }),
