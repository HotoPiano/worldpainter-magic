import { createGroundCoverLayer } from "../palettes/generator";

export const groundCoverLayers = {
  ...
  snow: createGroundCoverLayer({
    name: "snow",
    materials: [{ identifier: "conquest:snow_slab" }],
  }),
  ...
  */
  ...
  beachTop: createTerrain({
    name: "beach_top",
    materials: [
      { identifier: "conquest:wet_tan_sand_layer", count: 1000 },
    ],
  }),
